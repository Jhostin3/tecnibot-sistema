          ...
          <section className="mt-8 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
            <div className="flex flex-col gap-6 xl:flex-row xl:items-start xl:justify-between">
              <div className="w-full xl:max-w-sm">
                ...
                <Link
                  className="mt-4 block rounded-2xl border border-slate-100 bg-slate-50 p-6 transition-all hover:-translate-y-0.5 hover:shadow-md"
                  to={rutas.equipos}
                >
                  ...
                  <p className="mt-1 text-sm leading-6 text-slate-400">
                    Registra, importa y administra los equipos inscritos junto con su estructura competitiva.
                  </p>
                </Link>
              </div>
              ...
              <div className="w-full xl:flex-1">
                ...
                <form className="mt-4 w-full space-y-3" onSubmit={crearCategoria}>
