import { Bot, Cpu, Lock, Trophy, Zap } from 'lucide-react'
  ...
  return (
    <main className="grid min-h-screen bg-slate-50 md:grid-cols-2">
      <section className="relative hidden items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 px-10 text-center md:flex">
        ...
        <Cpu className="absolute left-10 top-10 h-10 w-10 animate-pulse text-blue-600 opacity-20" />
        <Bot className="absolute right-12 top-20 h-10 w-10 animate-pulse text-blue-600 opacity-20" />
      ...
      <section className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-900 to-indigo-900 px-6 py-10 md:bg-gradient-to-br md:from-slate-50 md:to-blue-50 md:px-8">
        ...
        >
          <div className="mb-6 text-center md:hidden">
            <p className="inline-flex items-center justify-center gap-2 text-3xl font-black tracking-normal text-white">
              <Zap className="inline h-8 w-8 text-cyan-400" />
              TECNIBOT
            </p>
          ...
          <div className="rounded-2xl bg-white p-6 shadow-2xl shadow-blue-950/30 md:rounded-none md:bg-transparent md:p-0 md:shadow-none">
            ...
            <button
              className="flex h-12 w-full items-center justify-center rounded-xl border border-amber-300 bg-amber-50 px-4 text-sm font-semibold text-amber-700 transition hover:bg-amber-100"
