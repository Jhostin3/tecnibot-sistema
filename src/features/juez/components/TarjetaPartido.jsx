...
export function TarjetaPartido({ alRegistrar, partido }) {
  ...
  return (
    <article className="rounded-xl border border-gray-700 bg-gray-800 p-6 shadow-lg">
      ...
      <div className="mt-6 grid grid-cols-[1fr_auto_1fr] items-start gap-3">
        ...
        <div className="min-w-0 rounded-xl border border-red-400 bg-gray-900 p-4 text-center">
      ...
      <button
        className="mt-6 min-h-14 w-full rounded-xl bg-cyan-500 px-5 py-3 text-lg font-semibold text-gray-950 transition hover:bg-cyan-400 disabled:cursor-not-allowed disabled:bg-gray-600 disabled:text-gray-300"
